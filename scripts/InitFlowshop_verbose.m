...
if ~isempty(checkpoint_files)
    ...
    if last_problem > 0 && last_problem < 10
        fprintf('\n========================================\n');
...
for j=start_problem:10 %Este for recorre los problemas (10)
  fprintf('\n========================================\n');
  fprintf('PROBLEMA %d/10 (lb=%d, ub=%d)\n', j, FS(j).lb, FS(j).ub);
  fprintf('========================================\n');
  ...
  fprintf('  [CHECKPOINT] Saved: problem %d/10\n', j);
